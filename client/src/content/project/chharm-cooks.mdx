...
Users can create new recipes with an intuitive form that includes a real-time preview of images and flexible fields for ingredients and directions. The hierarchical cuisine selection helps users categorise recipes accurately.

### Blog Creation

Recipes can be enhanced with blog-style descriptions using an integrated text editor. This feature allows users to add rich content, such as cooking tips and cultural insights, to their recipes.

## Recipe Showcase

Recipes are showcased on the Home Page with detailed information, including popularity, creation, and modification dates. Only the authors of the recipes can delete their entries.

### Recipe Edit

Logged-in users who created a recipe can edit it, with all fields pre-populated for easy updates.

### Recipe Card

The Recipe Card provides essential details in a streamlined format, including an interactive ingredients list for efficient cooking.

## Rating and Commenting

Users can rate recipes from 1 to 5 stars and leave comments. The average rating is displayed on recipe cards for quick reference.

## User Profile

The User Profile feature allows users to follow others, view detailed profiles, and explore their recipes and connections.
...
Users can manage their profile information, including profile picture, social media links, and personal details.

## User Ranking

A ranking system displays users based on the number of recipes they’ve created, along with the most common cuisine of their recipes.
