...
- **iSAID Dataset**: A large-scale aerial imagery dataset adapted for training and evaluation.
- **ResNet-101**: Backbone architecture used for feature extraction in object detection models.
