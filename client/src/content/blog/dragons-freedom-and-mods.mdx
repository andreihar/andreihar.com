...
<StorageImg id="dragons-freedom-and-mods/dragon" blog={true} width="875" alt="Image" title="The Elder Scrolls V: Skyrim (2011)" />
...
<StorageImg id="dragons-freedom-and-mods/scenery" blog={true} width="875" alt="Image" title="Skyrim Northern Lights" />
...
<StorageImg id="dragons-freedom-and-mods/banner" blog={true} width="875" alt="Image" title="You can play Skyrim without ever becoming the Dragonborn or facing dragon attacks" />
...
<StorageImg id="dragons-freedom-and-mods/enderal" blog={true} width="875" alt="Image" title="Enderal: Forgotten Stories (2016)" />
